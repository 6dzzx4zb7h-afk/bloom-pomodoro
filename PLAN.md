...
### - [ ] 10.2 One-tap session→goal credit in the debrief
...
### - [ ] 10.3 Day plan model — extend 9.6's daily target, frozen snapshots, derived actuals
...
### - [ ] 10.6 Outlook from your own throughput — guarded, descriptive, one surface each
...
### - [ ] 10.7 Foundations — data model (four curated, one custom, one derived)
...
### - [ ] 10.9 Two weeks of dots — consistency shown, never guarded (+ yesterday grace)
...
### - [ ] 10.10 Cue anchors and gentle restart
...
### - [ ] 10.11 In the record — History chips, one weekly line, stewardship proofs
...
### - [ ] 10.12 Phase 10 copy pass & voice audit
